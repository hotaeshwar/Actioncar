                  ...
                  <div className="flex-1">
                    ...
                    <div className="space-y-3 sm:space-y-4 text-sm sm:text-base lg:text-lg" style={{ color: '#1393c4' }}>
                      <p className="leading-relaxed">
                        At <span className="font-semibold">Action Car Detailing</span>, we do more than clean cars — we restore, protect, and elevate them. Based in Winnipeg with 12+ years of industry experience.
                      </p>
